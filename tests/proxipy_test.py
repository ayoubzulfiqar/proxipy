...
def test_content_type_validation(client):
    ...
    # Note: This test may hit rate limits in CI environments
    response = client.get("/proxy?url=https://httpbin.org/json")
...
def test_invalid_content_type(client):
    ...
    assert security.validate_content_type("application/json")
    assert security.validate_content_type("text/html")
...
def test_configuration_loading():
    ...
    # Test helper methods
    assert settings.is_binary_content("application/pdf")
    assert settings.is_text_content("application/json")
